...
class AAFMService:
    ...
    def get_ref_config(self, fm: VariabilityModel) -> Configuration:
        elements = {}
        features = self.get_features_by_attribute(fm.root, 'reference')
        print(features)
    ...
    def get_features_by_attribute(self, feature, attr: str):
        features = []
        ...
        for relation in feature.relations:
            for child in relation.children:
                features = features + self.get_features_by_attribute(child, attr)
        return features
